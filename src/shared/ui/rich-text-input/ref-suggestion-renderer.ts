...
const POPUP_CLASS =
  'fixed z-[9999] max-h-60 w-72 overflow-auto rounded-md border border-border-strong bg-surface p-1 text-sm shadow-lg';
  ...
  return () => {
    ...
    function render() {
      ...
      items.forEach((it, i) => {
        ...
        tag.className = 'shrink-0 font-mono text-xs text-foreground-faint';
