    ...
    >
      ...
      <div class="grid gap-3 sm:grid-cols-2">
        ...
        <label class="flex flex-col gap-1 text-sm">
          ...
          />
          <span class="text-xs text-slate-500 dark:text-slate-400">Lowercase, digits, hyphens. Unique within universe.</span>
        </label>
      </div>
      ...
      <div class="flex flex-col gap-1 text-sm">
        <span class="font-medium text-slate-700 dark:text-slate-300">Plotlines</span>
        <app-combobox-picker
